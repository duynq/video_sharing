...
RSpec.describe 'Sessions', type: :request do
  ...
  describe 'POST /create' do
    ...
    context 'when login faily' do
      let!(:user) {FactoryBot.create :user, email: 'quanduyx188@gmail.com', password: '12345678'}
      ...
      it 'the password is wrong' do
        post '/sign_in', params: { user: {email: 'quanduyx188@gmail.com', encrypted_password: '12345678910' }}
        expect(response).to redirect_to(:root)
        follow_redirect!
